...
document.querySelectorAll('.fi').forEach(el => {
  // Elemen .fi di #hero SENGAJA tidak langsung dikasih class 'on' dan tidak di-observe di sini.
  // Hero selalu terlihat penuh sejak awal (tidak discroll masuk), jadi reveal-nya dipicu manual
  // oleh triggerHeroReveal() di dalam unlockSite(), persis saat overlay countdown/PIN hilang.
...
function triggerHeroReveal(){
  document.querySelectorAll('#hero .fi').forEach(el => el.classList.add('on'));
}
